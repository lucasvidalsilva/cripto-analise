...
# extract dos dados das criptomoedas
...
# load dos dados extraídos para o Postgres
def carregar_dados(dados, schema='dw'):
    df = pd.DataFrame(dados)
    df.to_sql("bronze-criptosinfo", engine, schema=schema, if_exists="append", index=False)
